package edu.tecii.android.aplicacion5;
    ...
    public void mostrarNotificacion(int i){
        ...
        switch (i){
            case 0: {
                ...
                notificacion1.setContentText("Hola mundo notificacion 1");
            ...
            case 1: {
                ...
                notificacion1.setContentText("Hola mundo notificacion 2");
                notificacion1.setSmallIcon(R.mipmap.ic_launcher);
                notificacion1.setSound(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.song1));
                notificacion1.setPriority(NotificationCompat.PRIORITY_DEFAULT);
            ...
            case 2: {
                ...
                Bitmap imagen = BitmapFactory.decodeResource(getResources(),R.mipmap.ic_launcher);
                estilo.bigPicture(imagen);
                estilo.setSummaryText("Titulo de la notificacion 3");
            ...
            case 3: {
                ...
                notificacion1.addAction(android.R.drawable.ic_menu_add,"nueva activity",intent2);
                notificacion1.setContentIntent(intent);
